...
signInForm.addEventListener('submit', (e) => {
    ...
    signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            window.location.href = 'http://127.0.0.1:5500/index.html';  // Redirect after successful sign-in
        })
        .catch((error) => {
            console.error(error.message);
...
document.getElementById('googleSignInButton').addEventListener('click', () => {
    ...
    .then((result) => {
        ...
        signInStatus.style.color = 'green';
        window.location.href = 'http://127.0.0.1:5500/index.html';  // Redirect after successful Google Sign-In
    })
    .catch((error) => {
